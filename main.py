    ...
    "Медицина": {
        "Как записаться к врачу": {
            ...
            Если идёте в государственную поликлинику:
                ...
                Если вам до 18 лет — записываемся к педиатру,
                усли старше — идём к терапевту.
                ...
                После приёма вам либо сразу выдают направления,
                либо отправляют обратно в регистратуру, чтобы записали к нужным врачам.
            """
        }
    }
}
